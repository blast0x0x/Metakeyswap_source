    ...
    <IntroductionWrapper>
      <CardBody>
        <div>
          ...
          <List>
            <li>{t('200,000,000,000 OVE will be distributed to wallets who joined the presale.')}</li>
          </List>
          <Heading mb="10px">{t('After HardCap is reached')}:</Heading>
          <List>
            <li>{t('300,000,000,000 OVE will be distributed to wallets who joined the presale.')}</li>
          </List>
