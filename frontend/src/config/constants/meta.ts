...
export const DEFAULT_META: PageMeta = {
  title: 'MetakeySwap',
  description:
    'The most popular AMM on BSC by user count! Earn CAKE through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by MetakeySwap), NFTs, and more, on a platform you can trust.',
  image: 'https://metakeyswap.com/images/hero.png',
}
...
const getPathList = (t: ContextApi['t']): PathList => {
  return {
    ...
    defaultTitleSuffix: t('MetakeySwap'),
  }
}
